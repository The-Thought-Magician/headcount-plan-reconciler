    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-24">
        <div className="grid gap-6 md:grid-cols-2">
          {/* Free plan */}
          <div className="rounded-2xl border border-teal-500/40 bg-zinc-900/60 p-8 ring-1 ring-teal-500/20">
            ...
            <p className="mt-2 text-sm text-zinc-400">Full platform, every feature, unlimited workspaces.</p>
            ...
            <Link
              href="/auth/sign-up"
              className="mt-8 block rounded-lg bg-teal-600 py-3 text-center text-sm font-semibold text-white hover:bg-teal-500"
            >
              Start free
            </Link>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-8">
            ...
            <button
              disabled
              className="mt-8 w-full cursor-not-allowed rounded-lg border border-zinc-700 py-3 text-center text-sm font-semibold text-zinc-500"
            >
